...
#motorway_label[zoom>=11][zoom<=14][reflen<=8] {
  ...
  shield-fill: @other_text;
  shield-file: url(img/shield-1.png);
  [type='motorway'] {
    [reflen=1] { shield-file: url(img/shield-1.png); }
    [reflen=2] { shield-file: url(img/shield-2.png); }
    [reflen=3] { shield-file: url(img/shield-3.png); }
    [reflen=4] { shield-file: url(img/shield-4.png); }
    [reflen=5] { shield-file: url(img/shield-5.png); }
    [reflen=6] { shield-file: url(img/shield-6.png); }
    [reflen=7] { shield-file: url(img/shield-7.png); }
    [reflen=8] { shield-file: url(img/shield-8.png); }
  }
  [type='trunk'] {
    [reflen=1] { shield-file: url(img/shield-1.png); }
    [reflen=2] { shield-file: url(img/shield-2.png); }
